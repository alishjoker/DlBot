...
admin=["uf8a48d9747927d8e1c14cf1cae0f6539"]
wait = {
    'contact':True,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':False,
    'message':"Thanks For Add Self Bot",
    "lang":"JP",
    "comment":"Thanks For Add  Self Bot",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#-----------------------------------------------
              ...
              if msg.from_ in admin:
                msg.contentType = 13
                msg.contentMetadata = {'mid': 'ubb8d2595fcc42104153f67a53eb35d78'}
                cl.sendMessage(msg)
                cl.sendText(msg.to,"Powered By Alish")         
#-----------------------------------------------
            elif "Bc " in msg.text:
              if msg.from_ in admin:
...
#-----------------------------------------------	
              ...
              if msg.from_ in admin: 
                cl.sendText(msg.to,"BOT By Alish Joker")
                cl.sendText(msg.to,"BOT By Line.me/ti/p/~joker.alish")                
#-----------------------------------------------	
